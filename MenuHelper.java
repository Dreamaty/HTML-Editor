...
public class MenuHelper {
    ...
    public static void initHelpMenu(View view, JMenuBar menuBar) {
        ...
        addMenuItem(helpMenu, "About the program", view);
    }
    ...
    public static void initAlignMenu(View view, JMenuBar menuBar) {
        ...
        addMenuItem(alignMenu, new StyledEditorKit.AlignmentAction("Left-aligned", StyleConstants.ALIGN_LEFT));
        addMenuItem(alignMenu, new StyledEditorKit.AlignmentAction("Centered", StyleConstants.ALIGN_CENTER));
        addMenuItem(alignMenu, new StyledEditorKit.AlignmentAction("Right-aligned", StyleConstants.ALIGN_RIGHT));
